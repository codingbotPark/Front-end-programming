...
export default curry( /*#__PURE__*/_regeneratorRuntime.mark(function takeWhileL(f, iter) {
  var prev, ok, _iterator, _step, _loop, _ret;

  return _regeneratorRuntime.wrap(function takeWhileL$(_context2) {
    while (1) {
                ...
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    return prev = prev.then(function (_) {
                      ...
                      return (ok = _ok) ? a : _Promise.reject(nop);
                    });
