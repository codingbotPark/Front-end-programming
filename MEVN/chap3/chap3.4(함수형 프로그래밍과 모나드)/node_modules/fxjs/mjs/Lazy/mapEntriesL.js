...
export default curry( /*#__PURE__*/_regeneratorRuntime.mark(function mapEntriesL(f, iter) {
  var _iterator, _step, _loop;

  return _regeneratorRuntime.wrap(function mapEntriesL$(_context2) {
    while (1) {
            ...
            return _regeneratorRuntime.wrap(function _loop$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _step$value = _slicedToArray(_step.value, 2), k = _step$value[0], a = _step$value[1];
                    _context.next = 3;
