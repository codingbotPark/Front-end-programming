...
function curry2(f) {
  return function (a) {
    ...
    return _.length > 1 ? f.apply(void 0, (0, _concat.default)(_context = [a]).call(_context, _)) : _.length === 1 ? function () {
      var _context2;
      ...
      return f.apply(void 0, (0, _concat.default)(_context2 = [a, _[0]]).call(_context2, __));
    } : function (b) {
      var _context3;
      ...
      return _.length ? f.apply(void 0, (0, _concat.default)(_context3 = [a, b]).call(_context3, _)) : function () {
        var _context4;
        ...
        return f.apply(void 0, (0, _concat.default)(_context4 = [a, b]).call(_context4, _));
      };
    };
  };
}