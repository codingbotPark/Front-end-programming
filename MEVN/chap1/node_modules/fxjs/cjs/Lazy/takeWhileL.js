...
var resolved = _promise.default.resolve();

var _default = (0, _curry.default)( /*#__PURE__*/_regenerator.default.mark(function takeWhileL(f, iter) {
  var prev, ok, _iterator, _step, _loop, _ret;

  return _regenerator.default.wrap(function takeWhileL$(_context2) {
    while (1) {
            ...
            return _regenerator.default.wrap(function _loop$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    a = _step.value;
                    _ok = ok && (0, _go.default)(a, f);

                    if (!(_ok instanceof _promise.default)) {
                      _context.next = 9;
                      break;
                    }

                    _ok.catch(_noop.default);

                    _context.next = 6;
                    return prev = prev.then(function (_) {
                      return _ok;
                    }).then(function (_ok) {
                      return (ok = _ok) ? a : _promise.default.reject(_nop.default);
                    });
