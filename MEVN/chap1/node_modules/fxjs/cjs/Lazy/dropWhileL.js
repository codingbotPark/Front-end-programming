...
var _noop = _interopRequireDefault(require("../Strict/noop.js"));

var _nop = _interopRequireDefault(require("../Strict/nop.js"));

var _flatL = _interopRequireDefault(require("./flatL.js"));
...
var _default = (0, _curry.default)( /*#__PURE__*/_regenerator.default.mark(function dropWhileL(f, iter) {
  var prev, ok, _iterator, _step, _loop, _ret;

  return _regenerator.default.wrap(function dropWhileL$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          prev = null, ok = false;
          iter = (0, _toIter.default)(iter);
            ...
            return _regenerator.default.wrap(function _loop$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    a = _step.value;
                    cond = ok || (0, _go.default)(a, f);

                    if (!(cond instanceof _promise.default)) {
                      _context.next = 9;
                      break;
                    }

                    cond.catch(_noop.default);
                    _context.next = 6;
                    return prev = (prev || _promise.default.resolve()).then(function (_) {
                      return cond;
                    }).then(function (c) {
                      return (ok = !c) ? a : _promise.default.reject(_nop.default);
                    });

                  case 6:
                    prev = prev.catch(_noop.default);
                    _context.next = 13;
                    break;
                  ...
                  case 9:
                    ...
                    return _context.delegateYield((0, _flatL.default)([a, iter]), "t0", 11);
